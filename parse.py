...
def team_batting():
    ...
    for i in range(length - 1):
        ...
        if team not in teams:
            teams.append(team)
            output[team] = [batting['H'][i], batting['R'][i], batting['R/G'][i],
...
def team_pitching():
    ...
    for i in range(length - 1):
        ...
        if team not in teams:
            teams.append(team)
            output[team] = [pitching['RA/G'][i], pitching['ERA'][i], pitching['WHIP'][i],
